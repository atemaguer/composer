...
export const pillButton =
  `inline-flex items-center rounded-full border ${appSoftBorder} ${appSoftSurface} text-app-muted ${appInsetHighlight} transition-colors hover:bg-app-text/[0.08] hover:text-app-text ${focusRing}`;
