...
export const composerDarkTheme: ComposerThemeDefinition = {
  ...
  colors: {
    ...
    secondary: "215 28% 18%",
    secondaryForeground: "214 26% 90%",
    muted: "215 22% 18%",
    mutedForeground: "216 14% 64%",
    border: "215 18% 26%",
    input: "215 22% 18%",
    ring: "213 100% 68%",
    destructive: "0 82% 64%",
    ...
    appShell: "#091522",
    appSidebar: "#101923",
    appSidebarTranslucent: "rgba(16, 25, 35, 0.82)",
    appPanel: "#17263a",
    appPanel2: "#1a2c42",
    appLine: "rgba(180, 204, 232, 0.12)",
    appLineStrong: "rgba(180, 204, 232, 0.18)",
    appLineBright: "rgba(210, 229, 252, 0.28)",
    appText: "#e7edf5",
    appMuted: "#aab4c3",
    appDim: "#747e8e",
    appBlue: "#65a7ff",
    ...
    overlay: "rgba(7, 17, 28, 0.68)",
    overlayStrong: "rgba(7, 17, 28, 0.88)",
    hover: "rgba(255, 255, 255, 0.06)",
    hoverStrong: "rgba(255, 255, 255, 0.1)",
    shadow: "0 22px 56px rgba(0, 0, 0, 0.32)",
    shadowStrong: "0 22px 56px rgba(0, 0, 0, 0.46)",
    focus: "rgba(101, 167, 255, 0.7)",
    selection: "rgba(101, 167, 255, 0.28)",
    editorBackground: "#0c1723",
    editorForeground: "#dce7f4",
    editorGutter: "#101923",
    editorLineNumber: "rgba(170, 180, 195, 0.55)",
    editorActiveLine: "rgba(101, 167, 255, 0.08)",
    editorSelection: "rgba(101, 167, 255, 0.22)",
    editorCursor: "#e7edf5"
  }
};
...
export const vercelLightTheme: ComposerThemeDefinition = {
  ...
  colors: {
    ...
    focus: "rgba(0, 104, 214, 0.62)",
    selection: "rgba(0, 104, 214, 0.2)",
    editorBackground: "#ffffff",
    editorForeground: "#1f2328",
    editorGutter: "#f6f8fa",
    editorLineNumber: "rgba(95, 99, 104, 0.72)",
    editorActiveLine: "rgba(0, 104, 214, 0.06)",
    editorSelection: "rgba(0, 104, 214, 0.18)",
    editorCursor: "#111111"
  }
};
...
export const composerLightFallbackTheme: ComposerThemeDefinition = {
  ...
  colors: {
    ...
    appDim: "#8190a3",
    appBlue: "#1871d6",
    focus: "rgba(24, 113, 214, 0.62)",
    selection: "rgba(24, 113, 214, 0.2)"
  }
};
